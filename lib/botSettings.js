 ...
 * (use number reply by default — compatible with all devices)
 *
...
function defaultSettings() {
  return {
    ...
    // ========================================================
    //
    // DEFAULT = false (number reply)
    //
    // false = number reply text menus (works on ALL devices)
    // true  = interactive WhatsApp buttons / lists
    //
    // Use .setting on btns  → enable buttons
    // Use .setting off btns → disable buttons (number reply)
    //
    // ========================================================
