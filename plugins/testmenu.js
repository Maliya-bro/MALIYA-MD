    ...
    try {
      ...
      if (btnsOn) {
        try {
          ...
          const ButtonV2 = vanzxy.ButtonV2 || vanzxy.default?.ButtonV2;
          ...
          if (ButtonV2) {
            ...
            // Single Select Popup List එක සැකසීම
            ...
            // Side-by-Side හැඩය සඳහා Quick Reply Ping බොත්තම එක් කිරීම
          ...
          console.log("VANZXY BUTTONV2 LIST ERROR:", err?.message || err);
        }
      }
